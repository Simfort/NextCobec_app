...
passed в объекте вопроса: true, если ответ покрывает суть вопроса на ≥ 70 % (учитывается смысловое соответствие), иначе false (в том числе если answerUser пустой);
