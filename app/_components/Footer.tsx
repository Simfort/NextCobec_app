...
export default function Footer() {
  return (
    <footer className="flex mt-auto bg-secondary text-background/50 py-5 flex-col items-center text-sm justify-center">
      <div className="flex items-center flex-col gap-5 justify-center px-5 ">
        ...
        <div className="flex gap-99 max-sm:flex-col items-center max-sm:gap-6">
          {" "}
